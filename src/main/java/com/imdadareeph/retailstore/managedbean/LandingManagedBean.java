package com.imdadareeph.retailstore.managedbean;
...
import com.imdadareeph.retailstore.dto.CommonUtils;
...
public class LandingManagedBean implements Serializable{
	...
	public IRetailStoreService getRetailService() {
		return retailService;
	}

	public void setRetailService(IRetailStoreService retailService) {
